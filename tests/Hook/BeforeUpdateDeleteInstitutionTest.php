...
use Mrstock\Servicesdk\Hook\BeforeUpdateDelete;
use Mrstock\Servicesdk\Hook\BeforeUpdateDeleteCompany;
use Mrstock\Servicesdk\Hook\BeforeUpdateDeleteInstitution;
use PHPUnit\Framework\TestCase;

class BeforeUpdateDeleteInstitutionTest extends TestCase
{
    ...
    public function testRun()
    {
        ...
        $param[2] = 'default';
        $beforeInsert = new BeforeUpdateDeleteInstitution();
